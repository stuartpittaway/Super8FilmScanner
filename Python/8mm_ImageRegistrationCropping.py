...
def OutputFolder() -> str:
    ...
    path = "/Users/... ENTER YOUR OUTPUT PATH HERE"
...
def ImageFolder() -> str:  
    ...
    path="/Users/... ENTER YOUR INPUT PATH HERE"
...
try:
    ...
    for filename in files:
     #   filename_number = filename.split("_")[1]
     #   filename_number = filename_number[:8]
     #   current_datetime = datetime.now().strftime("%Y-%m-%d_%H-%M-%S-")
                
     #   str_current_datetime = str(current_datetime)
     #   print("Current date & time : ", str_current_datetime)

     #   _file_name = filename_number + str_current_datetime + filename_number + ".png"
        
        print("Print492"+filename)
        filename = str(filename)
        
        _filename = filename[14:]
        print("Print493"+_filename)

        
        new_filename = os.path.join(output_path, os.path.basename(_filename))
